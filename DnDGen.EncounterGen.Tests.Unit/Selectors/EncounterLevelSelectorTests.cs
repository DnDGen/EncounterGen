...
namespace DnDGen.EncounterGen.Tests.Unit.Selectors
{
    ...
    public class EncounterLevelSelectorTests
    {
        ...
        public void SelectEncounterLevelForCreatures()
        {
            ...
            {
                new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = 90210, ChallengeRating = "42" }
            };
        ...
        public void ComputeEncounterLevelForCreatures(string challengeRating, int quantity, int encounterLevel)
        {
            encounter.Creatures = new[]
            {
                new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = quantity, ChallengeRating = challengeRating }
            };
        ...
        public void ChallengeRatingHigherThan2ForCreaturesFollowsEncounterLevelForChallengeRating2(string challengeRating)
        {
            ...
            var creature = new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = 0, ChallengeRating = challengeRating };
            var cr2Creature = new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = 0, ChallengeRating = ChallengeRatingConstants.Two };
        ...
        public void SelectEncounterLevelFromMultipleCreatueres()
        {
            ...
            {
                new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = 90210, ChallengeRating = "42" },
                new Creature { Type = new EncounterCreature { Name = "other creature" }, Quantity = 1337, ChallengeRating = "600" },
            };
        ...
        public void SelectEncounterLevelFromMultipleCreatueresOfSameChallengeRating()
        {
            ...
            {
                new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = 90210, ChallengeRating = "42" },
                new Creature { Type = new EncounterCreature { Name = "other creature" }, Quantity = 1337, ChallengeRating = "42" },
            };
            ...
            encounter.Creatures = new[]
            {
                new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = 90210 + 1337, ChallengeRating = "42" },
            };
        ...
        public void ChallengeRatingOfZeroFromCreatureDoesNotAffectEncounterLevel()
        {
            encounter.Creatures = new[]
            {
                new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = 1, ChallengeRating = ChallengeRatingConstants.One },
                new Creature { Type = new EncounterCreature { Name = "other creature" }, Quantity = 100, ChallengeRating = ChallengeRatingConstants.Zero },
            };
        ...
        public void AmountOfZeroFromCreatureDoesNotAffectEncounterLevel()
        {
            ...
            {
                new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = 1, ChallengeRating = ChallengeRatingConstants.One },
                new Creature { Type = new EncounterCreature { Name = "other creature" }, Quantity = 0, ChallengeRating = "42" },
            };
        ...
        public void NegativeAmountFromCreatureDoesNotAffectEncounterLevel()
        {
            ...
            {
                new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = 1, ChallengeRating = ChallengeRatingConstants.One },
                new Creature { Type = new EncounterCreature { Name = "other creature" }, Quantity = -1, ChallengeRating = "42" },
            };
        ...
        public void NegativeAmountFromCreatureOfSameChallengeRatingDoesNotAffectEncounterLevel()
        {
            encounter.Creatures = new[]
            {
                new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = 2, ChallengeRating = ChallengeRatingConstants.One },
                new Creature { Type = new EncounterCreature { Name = "other creature" }, Quantity = -1, ChallengeRating = ChallengeRatingConstants.One },
            };
        ...
        public void GetEncounterLevelFromCharacters()
        {
            encounter.Creatures = new[]
            {
                new Creature { Type = new EncounterCreature { Name = CreatureDataConstants.Character }, Quantity = 90210, ChallengeRating = "42" },
                new Creature { Type = new EncounterCreature { Name = CreatureDataConstants.Character }, Quantity = 1337, ChallengeRating = "600" },
            };
        ...
        public void GetEncounterLevelFromCharactersAndCreatures()
        {
            encounter.Creatures = new[]
            {
                new Creature { Type = new EncounterCreature { Name = "creature" }, Quantity = 90, ChallengeRating = "21" },
                new Creature { Type = new EncounterCreature { Name = "other creature" }, Quantity = 13, ChallengeRating = "37" },
                new Creature { Type = new EncounterCreature { Name = CreatureDataConstants.Character }, Quantity = 12, ChallengeRating = "34" },
                new Creature { Type = new EncounterCreature { Name = CreatureDataConstants.Character }, Quantity = 23, ChallengeRating = "45" },
            };
        ...
        public void GetEncounterLevelForCharacterSubtypes()
        {
            encounter.Creatures = new[]
            {
                new Creature { Type = new EncounterCreature { Name = "creature", SubCreature = new EncounterCreature { Name = CreatureDataConstants.Character } }, Quantity = 90210, ChallengeRating = "42" },
                new Creature { Type = new EncounterCreature { Name = "creature", SubCreature = new EncounterCreature { Name = CreatureDataConstants.Character } }, Quantity = 1337, ChallengeRating = "600" },
            };
