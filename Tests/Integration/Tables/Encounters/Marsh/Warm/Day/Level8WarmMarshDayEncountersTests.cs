...
namespace EncounterGen.Tests.Integration.Tables.Encounters.Marsh.Warm.Day
{
    ...
    public class Level8WarmMarshDayEncountersTests : TypeAndAmountPercentileTests
    {
        ...
        [TestCase(27, 28, CreatureConstants.Hydra + ", 9 heads", RollConstants.One)]
        [TestCase(29, 30, CreatureConstants.Cryohydra + ", 7 heads", RollConstants.One)]
        [TestCase(31, 32, CreatureConstants.Pyrohydra + ", 7 heads", RollConstants.One)]
