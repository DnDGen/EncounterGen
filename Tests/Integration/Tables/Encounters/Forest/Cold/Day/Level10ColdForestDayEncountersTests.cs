...
namespace EncounterGen.Tests.Integration.Tables.Encounters.Forest.Cold.Day
{
    ...
    public class Level10ColdForestDayEncountersTests : TypeAndAmountPercentileTests
    {
        ...
        [TestCase(47, 48, CreatureConstants.FormianTaskmaster, RollConstants.OneD3Plus1)]
        [TestCase(49, 50, CreatureConstants.FormianMyrmarch, RollConstants.One)]
        [TestCase(51, 52, CreatureConstants.Golem_Clay, RollConstants.One)]
        [TestCase(53, 54, CreatureConstants.Golem_Flesh, RollConstants.OneD3Plus1)]
        [TestCase(55, 56, CreatureConstants.Avoral, RollConstants.OneD2)]
        [TestCase(57, 58, CreatureConstants.NessianWarhound, RollConstants.OneD2)]
        [TestCase(59, 60, CreatureConstants.Janni, RollConstants.OneD6Plus5)]
        [TestCase(61, 62, CreatureConstants.Lillend, RollConstants.OneD3Plus1)]
        [TestCase(63, 64, CreatureConstants.Salamander_Noble, RollConstants.One)]
        [TestCase(65, 66, CreatureConstants.Slaad_Gray, RollConstants.One)]
        [TestCase(67, 68, CreatureConstants.Slaad_Red, RollConstants.OneD3Plus1)]
        [TestCase(69, 70, CreatureConstants.Vrock, RollConstants.OneD2)]
        [TestCase(71, 72, CreatureConstants.Ravid, RollConstants.One,
            CreatureConstants.AnimatedObject_Colossal, RollConstants.One)]
        [TestCase(73, 78, CreatureConstants.Dragon, RollConstants.One)]
        ...
        [TestCase(87, 100, CreatureConstants.Character + "[7]", RollConstants.OneD3Plus1)]
