...
namespace EncounterGen.Tests.Integration.Tables.Encounters.Dungeon
{
    ...
    public class Level4DungeonEncountersTests : TypeAndAmountPercentileTests
    {
        ...
        [TestCase(36, 40, CreatureConstants.Character, RollConstants.OneD3)]
        ...
        [TestCase(21, 23, CreatureConstants.FormianWarrior, RollConstants.One, CreatureConstants.FormianWorker, RollConstants.OneD3)]
        [TestCase(24, 26, CreatureConstants.Imp, RollConstants.One, CreatureConstants.Lemure, RollConstants.OneD3)]
        [TestCase(61, 62, CreatureConstants.Bugbear, RollConstants.One, CreatureConstants.Hobgoblin, RollConstants.OneD6Plus3)]
        [TestCase(66, 67, CreatureConstants.Gnoll, RollConstants.OneD3, CreatureConstants.Hyena, RollConstants.OneD3)]
        [TestCase(68, 70, CreatureConstants.Lizardfolk, RollConstants.OneD3, CreatureConstants.Lizard_Giant, RollConstants.One)]
        [TestCase(74, 76, CreatureConstants.Ogre, RollConstants.One, CreatureConstants.Orc, RollConstants.OneD4Plus2)]
        [TestCase(77, 78, CreatureConstants.Orc, RollConstants.OneD3, CreatureConstants.Boar_Dire, RollConstants.OneD2)]
        [TestCase(79, 80, CreatureConstants.Worg, RollConstants.OneD2, CreatureConstants.Goblin, RollConstants.OneD4Plus2)]
