...
namespace EncounterGen.Tests.Integration.Tables.Encounters.EffectiveLevels
{
    ...
    public class Level20EncounterLevelTests : TypeAndAmountPercentileTests
    {
        ...
        [TestCase(1, 5, "16", MultiplierConstants.Quadruple)]
        [TestCase(6, 10, "17", MultiplierConstants.Triple)]
        [TestCase(11, 20, "18", MultiplierConstants.Double)]
        [TestCase(21, 30, "19", MultiplierConstants.HalfAgain)]
        [TestCase(31, 100, "20", MultiplierConstants.Same)]
