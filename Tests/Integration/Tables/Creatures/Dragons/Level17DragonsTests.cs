...
{
    [TestFixture]
    public class Level17DragonsTests : PercentileTests
    {
        protected override string tableName
        {
            get
            {
                return string.Format(TableNameConstants.LevelXDragons, 17);
            }
        }
        ...
        [TestCase(CreatureConstants.Dragon_White_Ancient, 1, 16)]
