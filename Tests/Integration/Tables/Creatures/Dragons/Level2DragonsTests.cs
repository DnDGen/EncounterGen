...
{
    [TestFixture]
    public class Level2DragonsTests : PercentileTests
    {
        protected override string tableName
        {
            get
            {
                return string.Format(TableNameConstants.LevelXDragons, 2);
            }
        }
        ...
        [TestCase(CreatureConstants.Dragon_White_VeryYoung, 1, 16)]
