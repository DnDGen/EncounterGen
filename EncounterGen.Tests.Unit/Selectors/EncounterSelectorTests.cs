...
namespace EncounterGen.Tests.Unit.Selectors
{
    ...
    public class EncounterSelectorTests
    {
        ...
        {
            var creature = encounterSelector.BuildCreature("creature name");
        ...
        {
            var creature = encounterSelector.BuildCreature("creature name", "description");
        ...
        {
            var creature = encounterSelector.BuildCreature("creature name", subtype: "subtype");
        ...
        {
            var creature = encounterSelector.BuildCreature("creature name", challengeRating: "challenge rating");
        ...
        {
            var creature = encounterSelector.BuildCreature("creature name", baseRace: "base race");
        ...
        {
            var creature = encounterSelector.BuildCreature("creature name", metarace: "metarace");
        ...
        {
            var creature = encounterSelector.BuildCreature("creature name", characterClasses: new[] { "class" });
        ...
        {
            var creature = encounterSelector.BuildCreature("creature name", characterClasses: new[] { "class", "other class" });
        ...
        {
            var creature = encounterSelector.BuildCreature("creature name", "description", "subtype", "challenge rating", "base race", "metarace", "class", "other class");
        ...
        public void BuildEncounter()
        {
            ...
            var encounter = encounterSelector.BuildEncounter(creaturesAndAmounts);
        ...
        {
            var creature = "creature name(description)$subtype$[challenge rating]{base race}#metarace#@class&other class@";
            var challengeRating = encounterSelector.SelectChallengeRatingFrom(creature);
        ...
        public void SelectCharacterClass()
        {
            ...
            var characterClasses = encounterSelector.SelectCharacterClassesFrom(creature);
        ...
        {
            var creature = "creature name(description)$subtype$[challenge rating]{base race}#metarace#@class&other class@";
            var description = encounterSelector.SelectDescriptionFrom(creature);
        ...
        {
            var creature = "creature name(description)$subtype$[challenge rating]{base race}#metarace#@class&other class@";
            var subtype = encounterSelector.SelectSubtypeFrom(creature);
