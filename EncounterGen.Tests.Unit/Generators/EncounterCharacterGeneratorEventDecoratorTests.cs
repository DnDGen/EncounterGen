...
namespace EncounterGen.Tests.Unit.Generators
{
    ...
    public class EncounterCharacterGeneratorEventDecoratorTests
    {
        ...
        public void DecoratorLogsEvents()
        {
            ...
            mockEventQueue.Verify(q => q.Enqueue("EncounterGen", $"Beginning generation of characters from 2 creatures"), Times.Once);
            mockEventQueue.Verify(q => q.Enqueue("EncounterGen", "Completed generation of 3 characters"), Times.Once);
        }
    }
}
