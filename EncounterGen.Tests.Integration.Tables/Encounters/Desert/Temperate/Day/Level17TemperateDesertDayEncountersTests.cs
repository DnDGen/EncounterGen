...
namespace EncounterGen.Tests.Integration.Tables.Encounters.Desert.Temperate.Day
{
    [TestFixture]
    public class Level17TemperateDesertDayEncountersTests : TypeAndAmountPercentileTests
    {
        protected override string tableName
        {
            get
            {
                return string.Format(TableNameConstants.LevelXENVIRONMENTEncounters, 17, EnvironmentConstants.TemperateDesertDay);
            }
        }
