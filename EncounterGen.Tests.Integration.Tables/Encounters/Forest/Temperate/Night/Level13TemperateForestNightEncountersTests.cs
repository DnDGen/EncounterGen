...
namespace EncounterGen.Tests.Integration.Tables.Encounters.Forest.Temperate.Night
{
    [TestFixture]
    public class Level13TemperateForestNightEncountersTests : TypeAndAmountPercentileTests
    {
        protected override string tableName
        {
            get
            {
                return string.Format(TableNameConstants.LevelXENVIRONMENTEncounters, 13, EnvironmentConstants.TemperateForestNight);
            }
        }
