...
namespace EncounterGen.Tests.Integration.Tables.Encounters.Civilized.Night
{
    ...
    public class Level6CivilizedNightEncountersTests : TypeAndAmountPercentileTests
    {
        ...
        [TestCase(71, 75, CreatureConstants.Ghost + "[1]", RollConstants.One)]
        [TestCase(76, 80, CreatureConstants.Character + "[6]", RollConstants.One)]
        [TestCase(81, 85, CreatureConstants.Character + "[5]", RollConstants.OneD2)]
        [TestCase(86, 90, CreatureConstants.Character + "[4]", RollConstants.OneD3)]
        [TestCase(91, 95, CreatureConstants.Character + "[3]", RollConstants.OneD3Plus1)]
        [TestCase(96, 100, CreatureConstants.Character + "[2]", RollConstants.OneD4Plus2)]
