...
{
    [TestFixture]
    public class Level14CivilizedDayEncountersTests : TypeAndAmountPercentileTests
    {
        protected override string tableName
        {
            get
            {
                return string.Format(TableNameConstants.LevelXENVIRONMENTEncounters, 14, EnvironmentConstants.CivilizedDay);
            }
        }
        ...
        [TestCase(56, 60, CreatureConstants.Warrior_Bandit + "[1d2+11]", RollConstants.OneD4Plus10,
            CharacterClassConstants.Fighter + "[9]", RollConstants.One)]
        [TestCase(61, 68, CreatureConstants.Character + "[14]", RollConstants.One)]
        [TestCase(69, 76, CreatureConstants.Character + "[13]", RollConstants.OneD2)]
        [TestCase(77, 84, CreatureConstants.Character + "[12]", RollConstants.OneD3)]
        [TestCase(85, 92, CreatureConstants.Character + "[11]", RollConstants.OneD3Plus1)]
        [TestCase(93, 100, CreatureConstants.Character + "[10]", RollConstants.OneD4Plus2)]
