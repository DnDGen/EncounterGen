...
namespace EncounterGen.Tests.Integration.Tables.Creatures
{
    ...
    public class AverageChallengeRatingsTests : CollectionTests
    {
        ...
        [TestCase(CreatureConstants.Dwarf_Captain, ChallengeRatingConstants.Three)]
        [TestCase(CreatureConstants.Dwarf_Leader, ChallengeRatingConstants.Two)]
        [TestCase(CreatureConstants.Dwarf_Lieutenant, ChallengeRatingConstants.Two)]
        [TestCase(CreatureConstants.Dwarf_Noncombatant, ChallengeRatingConstants.Zero)]
        [TestCase(CreatureConstants.Dwarf_Sergeant, ChallengeRatingConstants.One)]
        [TestCase(CreatureConstants.Dwarf_Warrior, ChallengeRatingConstants.OneHalf)]
        ...
        [TestCase(CreatureConstants.Elf_Warrior, ChallengeRatingConstants.OneHalf)]
        [TestCase(CreatureConstants.Elf_Captain, ChallengeRatingConstants.Three)]
        [TestCase(CreatureConstants.Elf_Leader, ChallengeRatingConstants.Two)]
        [TestCase(CreatureConstants.Elf_Lieutenant, ChallengeRatingConstants.Two)]
        [TestCase(CreatureConstants.Elf_Noncombatant, ChallengeRatingConstants.Zero)]
        [TestCase(CreatureConstants.Elf_Sergeant, ChallengeRatingConstants.One)]
        ...
        [TestCase(CreatureConstants.Gnome_Warrior, ChallengeRatingConstants.OneHalf)]
        [TestCase(CreatureConstants.Gnome_Captain, ChallengeRatingConstants.Three)]
        [TestCase(CreatureConstants.Gnome_Leader, ChallengeRatingConstants.Two)]
        [TestCase(CreatureConstants.Gnome_Lieutenant_3rd, ChallengeRatingConstants.One)]
        [TestCase(CreatureConstants.Gnome_Lieutenant_5th, ChallengeRatingConstants.Two)]
        [TestCase(CreatureConstants.Gnome_Sergeant, ChallengeRatingConstants.One)]
        ...
        [TestCase(CreatureConstants.Halfling_Warrior, ChallengeRatingConstants.OneHalf)]
        [TestCase(CreatureConstants.Halfling_Captain, ChallengeRatingConstants.Three)]
        [TestCase(CreatureConstants.Halfling_Leader, ChallengeRatingConstants.Two)]
        [TestCase(CreatureConstants.Halfling_Lieutenant, ChallengeRatingConstants.Two)]
        [TestCase(CreatureConstants.Halfling_Noncombatant, ChallengeRatingConstants.Zero)]
        [TestCase(CreatureConstants.Halfling_Sergeant, ChallengeRatingConstants.One)]
